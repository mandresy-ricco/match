...
let CardAsk = "<div class=\"col-12 col-sm-10 col-md-7 col-xl-4\">\n" +
    "                <div class=\"d-flex row pt-1 p-2 grad_1 rounded-sm box-shadow-md\">\n" +
    "                    <div class=\"d-flex col justify-content-end \">\n" +
    "                        <div>\n" +
    "                            <div class=\"d-flex col\">\n" +
    "                                <svg  xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" fill=\"white\" class=\"bi bi-bell mt-1\" viewBox=\"0 0 16 16\">\n" +
    ...
    "                                    <button onclick=\"manageReservation('--id-accept--')\"  class=\"font-weight-2 bg-white py-2 px-3 border-0 rounded-sm form-control  box-shadow-md\">Accepter</button>\n" +
    "                                    <button onclick=\"manageReservation('--id-deny--')\"  class=\"font-weight-2 bg-white  py-2 px-3 border-0  rounded-sm form-control box-shadow-md\">Refuser</button>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
